...
typedef enum msg_parse_result {
    ...
    MSG_PARSE_ERROR_WRONG_ARG_NUM,        /* parsing error: wrong number of arguments */
...
struct msg {
    ...
    msg_reply_t          reply;           /* generate message (error) reply (example: ping,invalid cmd,wrong arg num)*/
